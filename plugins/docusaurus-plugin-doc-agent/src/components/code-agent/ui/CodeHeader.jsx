...
export default function CodeHeader({ onCopyDisplay, onClearHistory }) {
        ...
        <div className="flex items-center justify-between px-6 py-3.5 border-b border-[var(--ifm-color-emphasis-200)] bg-[var(--ifm-color-emphasis-100)] shrink-0">
            ...
            <div className="flex items-center gap-2">
                <div className="flex items-center gap-1">
                    <button
                        onClick={handleCopy}
                        className={`w-7 h-7 border-none rounded bg-transparent cursor-pointer flex items-center justify-center transition-all ${copied ? 'text-emerald-500' : 'text-[var(--ifm-color-emphasis-600)] hover:text-[var(--ifm-color-emphasis-900)] hover:bg-[var(--ifm-color-emphasis-200)]'}`}
                        title="复制对话文本"
                    >
                        {copied ? (
